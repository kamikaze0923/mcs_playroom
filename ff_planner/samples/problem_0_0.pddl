...
(define (problem plan_0_0)
    ...
    (:init
        ...
        (canContain CounterTopType ContainerType)
        (canContain CounterTopType SpoonType)
        (canContain SinkType PlateType)
        (canContain SinkType EggType)
        (canContain SinkType BowlType)
        (canContain SinkType MugType)
        (canContain SinkType KnifeType)
        (canContain SinkType PotatoType)
        (canContain SinkType AppleType)
        (canContain SinkType TomatoType)
        (canContain SinkType ContainerType)
        (canContain SinkType ForkType)
        (canContain SinkType LettuceType)
        (canContain SinkType SpoonType)
        ...
        (canContain FridgeType ContainerType)
        (canContain FridgeType LettuceType)
        (canContain FridgeType BreadType)
        (canContain TableTopType PlateType)
        (canContain TableTopType BreadType)
        (canContain TableTopType EggType)
        (canContain TableTopType BowlType)
        (canContain TableTopType MugType)
        (canContain TableTopType KnifeType)
        (canContain TableTopType PotatoType)
        (canContain TableTopType AppleType)
        (canContain TableTopType TomatoType)
        (canContain TableTopType LettuceType)
        (canContain TableTopType ForkType)
        (canContain TableTopType ContainerType)
        (canContain TableTopType SpoonType)
        ...
        (canContain CabinetType KnifeType)
        (canContain CabinetType PotatoType)
        (canContain CabinetType ForkType)
        (canContain CabinetType ContainerType)
        (canContain CabinetType SpoonType)
        (canContain CabinetType BreadType)
